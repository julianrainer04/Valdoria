...
const files=['data/life-actions.js','data/scenarios.js','data/petitions.js','data/emergent.js','data/private-incidents.js','data/depth-systems.js','data/grand-systems.js','data/living-world.js','game.js'];
